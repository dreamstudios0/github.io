...
editableItems['.bg-img'] = ['background-color', 'box-shadow', 'background-size', 'background-repeat'];
...
editableItemOptions['nav a : font-weight'] = ['300','400','700','900'];
editableItemOptions['nav a.btn-nav : font-weight'] = ['300','400','700','900'];
...
editableItemOptions['.bg-img : background-size'] = ['auto', 'cover'];
editableItemOptions['.bg-img : background-repeat'] = ['no-repeat', 'repeat', 'repeat-x', 'repeat-y'];


var editableContent = ['.editContent', '.navbar a', 'a.edit', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', '.nav-callus', '.text-edit', '.btn', '.footer a:not(.fa)', '.tableWrapper'];
